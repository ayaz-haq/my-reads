...
const MyReads = ({books}) => {
    const currentlyReading = books.filter((book,id) => book.shelf==="currentlyReading")
    const wantToRead = books.filter((book,id) => book.shelf==="wantToRead")
    const read = books.filter((book,id) => book.shelf==="read")
    // const func = () => {
    //     // console.log(currentlyReading,wantToRead,read)
    //     console.log("previewLink",currentlyReading[0].previewLink)
    // }
    // func();
  return (
    <div>
